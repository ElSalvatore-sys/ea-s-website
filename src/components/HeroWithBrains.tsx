        ...
        <div className="text-center">
          ...
          >
            <div className="leading-[1.1]">
              <div className="text-white drop-shadow-[0_4px_8px_rgba(0,0,0,0.9)]">
                {language === 'de' ? 'Enterprise KI' : 'Enterprise AI'}
              </div>
              <div className="bg-gradient-to-r from-fuchsia-400 via-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow-[0_4px_8px_rgba(0,0,0,0.9)]">
